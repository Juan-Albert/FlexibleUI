...
namespace UITools
{
    public class HorizontalScrollSnap : ScrollSnapBase, IEndDragHandler
    {
        void Start()
        {
            ...
            _screensContainer.localPosition = new Vector3(_screensContainer.localPosition.x, 0f, _screensContainer.localPosition.z);
        ...
        private void DistributePages()
        {
            ...
            var pageStepValue = _childSize = childObjects[0].sizeDelta.x;
        ...
        public void OnEndDrag(PointerEventData eventData)
        {
            ...
            if (_scroll_rect.horizontal)
            {
                ...
                if (useFastSwipe && distance < panelDimensions.rect.width && distance >= fastSwipeThreshold)
                {
